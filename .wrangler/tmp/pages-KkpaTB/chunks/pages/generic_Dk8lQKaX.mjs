...
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemotePath, d as isRemoteAllowed } from '../astro/assets-service_i7oLR0nI.mjs';
import { g as getDefaultExportFromCjs, A as AstroError, l as InvalidImageService, n as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, b as createAstro, d as createComponent, o as ImageMissingAlt, e as renderTemplate, m as maybeRenderHead, f as addAttribute, s as spreadAttributes } from '../astro_BO0wYrHs.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_i7oLR0nI.mjs'
    ).then(n => n.n).catch((e) => {
